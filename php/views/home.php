        ...
        <section id="corpo">
            <article id="noticiaprincipal">
                ...
                <figure class="foto-legenda">
                    <img src="_imagens/icon.png">
                    <figcaption>
                        <h3>Processamento do Imagem</h3>
                        <P> imagem será modificada</P>
                    </figcaption>
                </figure>
                <h2>Métodos de processamento de imagens</h2>
                <ul>
                    <li>Metodo analógico; </li>
                    <li> Método digital.</li>
                </ul>
                <p>
                    Atualmente é muito usado o processamento imagens digitais, tal método foi sustituindo o modo analógico.
                </p>
